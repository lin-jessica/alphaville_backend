...
#exhibit
mod57 = Exhibit.find_or_create_by(name: "Boolean Assange's Cat's Science Fair", free: true, venue_id: wework.id)
fiesta = Exhibit.find_or_create_by(name: "Spanish Dinner Party", free: true, venue_id: foxhole.id)
